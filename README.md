# **ESP_8_BIT:** Atari 8 bit computers, NES and SMS game consoles on your TV with nothing more than a ESP32
## Supports NTSC/PAL color composite video output.
## Bluetooth Classic or IR keyboards and joysticks.
## This version also adds support for classic NES or SNES (one or two) controllers hardwired to the ESP32.
## Use SELECT + LEFT to access file menu and SELECT + START to reset.
## Optional SD card support with FAT 8.3 filenames.
## Option for NES to allow for 64 sprites on a scan line removing flicker
## See compile options in config.h 
...
The build can fit inside a gameboy clam shell with classic NES connectors.
...
```
Compiler used was Arduino V1.8.13 (newer versions should work as well)
